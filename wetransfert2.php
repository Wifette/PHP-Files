...
<form class="container" method="post" action="file.php" enctype="multipart/form-data">
        ...
        <div class="row">
                ...
                <div class="col-md-6 pt-5 pb-3 mx-auto">
                        <?php
                ...
                <div class="input-group mb-3">
                        ...
                        <div class="custom-file">
                            ...
                            <input type="file" class="custom-file-input" data-toggle="collapse" data-target="#collapsefile" name="fichier" id="fichier" aria-describedby="inputGroupFileAddon01">
